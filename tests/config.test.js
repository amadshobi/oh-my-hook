...
test("loadConfig reads a real omh.jsonc and merges", (t) => {
  ...
  assert.equal(merged.guard.planMode, false);
  assert.equal(merged.guard.readBeforeWrite, true);

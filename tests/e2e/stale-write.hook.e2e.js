...
import { createReadGuard } from "../../guard/read-guard.js";
...
try {
  ...
  writeFileSync(targetFile, "export const VERSION = 'v2';\n// changed externally\n");
  ...
  assert(/stale|berubah/i.test(message), `block message should mention stale/berubah: ${message.slice(0, 120)}`);
